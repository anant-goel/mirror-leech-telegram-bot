...
from bot import bot, app, dispatcher, updater, botStartTime, IGNORE_PENDING_REQUESTS, IS_VPS, PORT, alive, web, nox, OWNER_ID, AUTHORIZED_CHATS, LOGGER, IMAGE_URL
...
def start(update, context):
    ...
    buttons.buildbutton("Repo", "https://github.com/Krazy-Goel/test-5")
    buttons.buildbutton("Owner", "https://t.me/Anant_Goel")
...
def main():
    ...
    if os.path.isfile(".restartmsg"):
        ...
        try:
            text = "<b>Bot Has Started Now U Are Ready For Mirroring!!</b>"
